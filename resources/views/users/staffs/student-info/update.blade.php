...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Update {{ ucwords($student->name) }} details </h1>
        </div>
        <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ str_replace("-", "/", $student->date), old('dob') }}" name="dob">
                                @if ($errors->has('dob'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                name="country">
                                <option value="{{ $student->country}}">{{ ucwords($student->country) }}</option>
                          ...
                          <option value="Zimbabwe">Zimbabwe</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ ucwords($student->state), old('state') }}" name="state">
                                @if ($errors->has('state'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ ucwords($student->city), old('city') }}" name="city">
                                @if ($errors->has('city'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select
                                    ...
                                    <option value="{{ $student->faculty_id}}">{{ ucwords($student->faculty->faculty) }}</option>
                                    @if ($faculties)
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select
                                    ...
                                    name="dept"id="dept" >
                                    <option value="{{ $student->department_id }}">{{ ucwords($student->department->dept) }}</option>
